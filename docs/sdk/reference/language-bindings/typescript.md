...
Use Node.js 18 or later. Install [@withautonomi/antd](https://www.npmjs.com/package/@withautonomi/antd/v/0.1.0), which includes TypeScript declarations, in your application directory:

```bash
npm install @withautonomi/antd
```

Installing the client does not install or start antd. Keep the `@withautonomi/` scope: the npm package named `antd` is the unrelated Ant Design library.
